...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "UAS PCS - 0837"
    ...
    private fun getUser() {
        ...
        client.addHeader("Authorization", "token 93d6e81c2b8cb08e7b666ed92095b78c9a7da804")
